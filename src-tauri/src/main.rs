...
fn main() -> Result<(), Box<dyn std::error::Error>> {
  ...
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::llm_memo::add_llm_memo::add_llm_memo,
      commands::llm_memo::list_llm_memo::list_llm_memo,
      commands::llm_memo::get_llm_memo::get_llm_memo,
      commands::llm_memo::update_llm_memo::update_llm_memo,
      commands::llm_memo::delete_llm_memo::delete_llm_memo,
      ...
      commands::firestore::andoroid_notes::list_android_notes,
    ])
